...
type Unnamed_6_Query = { readonly blogThemeConfig: Maybe<Pick<BlogThemeConfig, 'webfontURL'>> };

type Unnamed_7_QueryVariables = Exact<{ [key: string]: never; }>;


type Unnamed_7_Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author' | 'siteUrl'>> }> };
